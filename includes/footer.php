...
<div class="pg-footer">
					...
					<div class="footer-content-column">
						<div class="footer-logo">
							<a class="footer-logo-link" href="#">
								...
								<div class="navbar__section--logo mb-2 mt-2">
					...
					<div class="footer-content-column">
						...
						<div class="footer-call-to-action">
							...
							<p class="footer-call-to-action-link-wrapper">
								<a class="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self">
									0124-64XXXX
								</a>
							</p>
						</div>
				...
				<div class="footer-copyright">
					<div class="footer-copyright-wrapper">
						<p class="footer-copyright-text">
							<a class="addobyte@gmail.com" href="#" target="_self">
								©2024. | Designed By: Addobyte@gmail.com| All rights reserved.
							</a>
						</p>
					</div>
				</div>
		...
		<!-- whatsup chat -->
		<div class="chat">
			<a href="https://wa.me/2536412584" target="_blank"><img src="img/whatsup.svg" alt="" /></a>
		</div>
		<!-- End footer Area -->
		<!-- End footer Area -->
		...
		<script src="https://kit.fontawesome.com/c7e067b762.js" crossorigin="anonymous"></script>
